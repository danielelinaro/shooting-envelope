...
def system_4(imposed_paths):
    ...
    ax[1,1].plot(sol['y'][2,0],sol['y'][3,0],'go',markerfacecolor='w',markersize=4)
    ax[1,1].plot(sol['y'][2,-1],sol['y'][3,-1],'ro',markerfacecolor='w',markersize=4)
    ax[1,1].set_xlabel('Ca')
    ax[1,1].set_ylabel('Na')
...
cmds = {'system-4': system_4, 'system-7': system_7}


cmd_descriptions = {'system-4': 'integrate the 4-dimensional neuron model', \
                    'system-7': 'integrate the 7-dimensional neuron model'}
