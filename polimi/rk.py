...
class RungeKuttaEnvelope(OdeSolver):
    ...
    def __init__(self, fun, t0, y0, t_bound, T_guess, max_step=np.inf,
        ...
        super(RungeKuttaEnvelope, self).__init__(lambda t,y: self._envelope_fun(t,y,None),
                                                 t0, y0, t_bound,
                                                 vectorized=False,support_complex=True)
        self.y_old = None
        ...
        self.f = self._envelope_fun(t0,y0,T_guess)
        self.h_abs = self.T
        self.T_prev = self.T
    ...
    def _dense_output_impl(self):
        ...
        return RkEnvelopeDenseOutput(self.t_old, self.t, self.y_old, Q)


class RK23Envelope(RungeKuttaEnvelope):
...
class RK45Envelope(RungeKuttaEnvelope):
...
class RkEnvelopeDenseOutput(DenseOutput):
    def __init__(self, t_old, t, y_old, Q):
        super(RkEnvelopeDenseOutput, self).__init__(t_old, t)
        self.h = t - t_old
        self.Q = Q
